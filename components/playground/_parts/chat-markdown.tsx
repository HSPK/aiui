...
/**
 * Markdown component overrides for assistant chat bubbles. Same shape
 * as `logs/_parts/markdown.tsx` but with bubble-flavoured spacing /
 * typography / a fancier CodeBlock that the chat surface uses. Kept
 * in its own file so future markdown tweaks for chat (e.g. citation
 * tooltips, callouts, math styling) don't bloat chat-message.tsx.
 */
...
export const markdownComponents = {
    ...
    // <p> rendered as <div> — react-markdown wraps mixed inline +
    // block content in <p>; CodeBlock is a <div>/<pre>; block-in-<p>
    // is invalid HTML → hydration error.
